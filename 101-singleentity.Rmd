...
1.  Do the following queries using SQL:
...
2.  Run the following queries and explain the differences in output. Write each query as a manager might state it.
